...
IMG_2 = getenv("IMG_2", "https://raw.githubusercontent.com/BROKENCOBRA/legend-alonemusc/main/etc/foreground.png")
IMG_3 = getenv("IMG_3", "https://raw.githubusercontent.com/BROKENCOBRA/legend-alonemusc/main/etc/foreground.png")
